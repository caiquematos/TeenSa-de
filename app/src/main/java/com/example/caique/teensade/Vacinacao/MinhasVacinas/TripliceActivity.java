...
public class TripliceActivity extends AppCompatActivity implements View.OnClickListener, DatePickerDialog.OnDateSetListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_triplice);

        mActivity = this;

        mDoseOne = findViewById(R.id.trip_card_1);
        mDoseTwo = findViewById(R.id.trip_card_2);
        mTextOne = findViewById(R.id.trip_text_1);
        mTextTwo = findViewById(R.id.trip_text_2);
