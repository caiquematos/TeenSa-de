...
public class IstTenActivity extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_ist_ten);


        WebView webViewOne = findViewById(R.id.ists_ten_web_1);
        WebView webViewTwo = findViewById(R.id.ists_ten_web_2);
        WebView webViewThree = findViewById(R.id.ists_ten_web_3);

        String text;
        text = "<html><body><p align=\"justify\">";
        text+= getString(R.string.ists_ten_text_1);
        text+= "</p></body></html>";
        ...
        text2+= getString(R.string.ists_ten_text_2);
        text2+= "</p></body></html>";
        ...
        text3+= getString(R.string.ists_ten_text_3);
        text3+= "</p></body></html>";
