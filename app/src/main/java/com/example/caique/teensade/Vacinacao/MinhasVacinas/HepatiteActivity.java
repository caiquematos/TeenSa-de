...
import com.example.caique.teensade.Vacinacao.GirlActivity;

import java.util.Calendar;

public class HepatiteActivity extends AppCompatActivity implements View.OnClickListener, DatePickerDialog.OnDateSetListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_hepatite);

        mDoseOne = findViewById(R.id.hepa_card_1);
        mDoseTwo = findViewById(R.id.hepa_card_2);
        mDoseThree = findViewById(R.id.hepa_card_3);
        mTextOne = findViewById(R.id.hepa_text_1);
        mTextTwo = findViewById(R.id.hepa_text_2);
        mTextThree = findViewById(R.id.hepa_text_3);
    ...
    public void onClick(View view) {
        switch (view.getId()) {
            case R.id.hepa_card_2:
                mDose = DOSE_TWO;
                break;
            case R.id.hepa_card_3:
                mDose = DOSE_THREE;
                break;
            default:
               mDose = DOSE_ONE;
