...
public class IstSevenActivity extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_ist_seven);

        WebView webViewOne = findViewById(R.id.ists_seven_web_1);
        WebView webViewTwo = findViewById(R.id.ists_seven_web_2);
        WebView webViewThree = findViewById(R.id.ists_seven_web_3);

        String text;
        text = "<html><body><p align=\"justify\">";
        text+= getString(R.string.ists_seven_text_1);
        text+= "</p></body></html>";
        ...
        text2+= getString(R.string.ists_seven_text_2);
        text2+= "</p></body></html>";
        ...
        text3+= getString(R.string.ists_seven_text_3);
        text3+= "</p></body></html>";
